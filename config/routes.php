...
return static function (RouteBuilder $routes) {
    ...
    $routes->scope('/', function (RouteBuilder $builder) {
        ...
        $builder->connect('/wallet/*', ['controller' => 'Users', 'action' => 'wallet']);
        $builder->connect('/knowledge/*', ['controller' => 'Users', 'action' => 'knowledge']);
        $builder->connect('/domains/*', ['controller' => 'Users', 'action' => 'domains']);
