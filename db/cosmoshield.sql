...
--
-- Host: localhost:8889
-- Generation Time: Jan 25, 2023 at 03:49 AM
...
(9, 10, 'asdfdsf', 2, '2023-01-24 05:03:36', '2023-01-24 05:03:36');
...
(1, 'sadf', 'sadf', 'saroya.com@gmail.com', 3, NULL, NULL, '2023-01-20 07:29:06', '2023-01-24 05:03:43'),
...
CREATE TABLE `settings` (
  ...
  `whois_api_key` varchar(64) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'support', 'support@superpad.finance', 'super@1234!', 'mail.superpad.finance', 587, 'at_ix50p08KlWE3m8qNqHiltafU1aFvh', '2022-03-15 13:20:49', '2023-01-23 00:00:19');
...
(9, NULL, NULL, 'admin@admin.com', 'admin@admin.com', '$2y$10$5Y31Kwu89Fs7cBeeqvV/suPBk3bCAc7we3Cim.RRL8c2rdxLWDgDK', 1, NULL, NULL, '2023-01-19 07:10:55', '2023-01-20 05:39:45'),
